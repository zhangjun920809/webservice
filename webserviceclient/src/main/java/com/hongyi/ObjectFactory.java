 ...
 * generated in the com.hongyi package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://hongyi.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://hongyi.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hongyi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hongyi.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hongyi.com/", name = "queryWeather")
